...
const Banner = () => {
    return (
        ...
        <img src="banner.jpg" alt="" className="md:px-48 md:py-20 w-full md:w-5/6 h-3/4" />
        <div className=" md:absolute top-40 right-80 bg-gray-800 bg-opacity-75 text-white px-2 my-5 md:px-20 mx-2 py-5 md:py-24 rounded-lg shadow-lg md:w-1/3">
            ...
            <h2 className="text-lg md:text-2xl font-bold mb-2">Embracing City Lights, Landmarks, And Iconic Culture.</h2>
            <div className="flex items-center justify-end md:mb-5 gap-2 ">
                <img src="Group - 2/calender.png" alt="" />
                <span className="">3 Days / 4 Night</span>
            </div>
            <hr />
            <div className="md:mb-10">
                <div className="flex justify-between md:mt-10">
                <div className="flex justify-start"><img src="Group - 2/like.png" className="pr-3" alt="" /><p>Home Pickup</p></div>
                <div className="flex justify-start"><img src="Group - 2/like.png" className="pr-3" alt="" />Night Food</div>
                </div>
    
                <div className="flex justify-start"><img src="Group - 2/like.png" className="pr-3" alt="" />Seaplane Flying</div>
            </div>
<hr />
