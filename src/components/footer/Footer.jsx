    ...
    return (
        <div>
            <div className="bg-gray-100">
                ...
                <div className="grid md:flex md:justify-center md:space-x-4 px-2 md:px-1">
                    <img src="Footer/1.jpg" alt="Person with backpack standing on a mountain" className="ml-0 rounded-lg md:w-1/6 w-full h-auto mb-4 md:mb-0 m-0" />
                    <img src="/Footer/2.jpg" alt="People camping in a scenic location" className="ml-0 rounded-lg md:w-1/6 w-full h-auto mb-4 md:mb-0" />
                    <img src="/Footer/6.jpg" alt="Person in a boat on a beautiful lake" className="rounded-lg md:w-1/6 w-full h-auto mb-4 md:mb-0" />
                    <img src="/Footer/4.jpg" alt="Group of friends hiking in the mountains" className="rounded-lg md:w-1/6 w-full h-auto mb-4 md:mb-0" />
                    <img src="/Footer/5.jpg" alt="Person with backpack standing on a mountain" className="rounded-lg md:w-1/6 w-full h-auto mb-4 md:mb-0" />
                </div>
